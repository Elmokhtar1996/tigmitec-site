        ...
        >
            <div className="container-custom">
                <div className="flex items-center justify-between">
                    ...
                    {/* Mobile Menu Button - VISIBILITY RESTORED */}
                    <button
                        onClick={toggleMobileMenu}
                        className="lg:hidden fixed top-3 right-4 p-2 text-blue-600 bg-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-50 focus:outline-none z-[99999]"
